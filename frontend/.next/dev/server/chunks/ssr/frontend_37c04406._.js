...
function SymptomChecker({ onBack }) {
    ...
    const calculateDiagnosis = async ()=>{
        const results = [];
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$diseases$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["diseasesDatabase"].forEach((disease)=>{
            let matchScore = 0;
